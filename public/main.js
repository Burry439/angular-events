...
/* harmony import */ var primeng_growl__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! primeng/growl */ "./node_modules/primeng/growl.js");
/* harmony import */ var primeng_growl__WEBPACK_IMPORTED_MODULE_38___default = /*#__PURE__*/__webpack_require__.n(primeng_growl__WEBPACK_IMPORTED_MODULE_38__);
/* harmony import */ var primeng_components_common_messageservice__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! primeng/components/common/messageservice */ "./node_modules/primeng/components/common/messageservice.js");
/* harmony import */ var primeng_components_common_messageservice__WEBPACK_IMPORTED_MODULE_39___default = /*#__PURE__*/__webpack_require__.n(primeng_components_common_messageservice__WEBPACK_IMPORTED_MODULE_39__);
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [
                ...
                primeng_growl__WEBPACK_IMPORTED_MODULE_38__["GrowlModule"],
            ...
            providers: [_services_auth_service__WEBPACK_IMPORTED_MODULE_8__["AuthService"], _services_gaurd_service__WEBPACK_IMPORTED_MODULE_10__["GaurdService"], primeng_components_common_messageservice__WEBPACK_IMPORTED_MODULE_39__["MessageService"]],
...
var EventsComponent = /** @class */ (function () {
    function EventsComponent(eventsService, dialog, dialog2, messageService) {
        this.eventsService = eventsService;
        this.dialog = dialog;
    ...
    EventsComponent.prototype.openCreateEventDialog = function () {
        ...
        dialog2.afterClosed()
            ...
            if (res == undefined) {
                ...
                _this.messageService.add({ severity: 'success', summary: 'Event added', detail: 'you created ' + res.name });
    ...
    EventsComponent.prototype.openEventDialog = function (id) {
        ...
        dialog.afterClosed()
            ...
            if (!res) {
                ...
                _this.messageService.add({ severity: 'success', summary: 'Event deleted', detail: 'you deleted ' + _this.events[index].name });
                ...
                _this.messageService.add({ severity: 'success', summary: 'left event', detail: 'you left ' + res.name });
            }
                ...
                console.log(_this.events[index].attending);
                _this.messageService.add({ severity: 'success', summary: 'Joined event', detail: 'you joined ' + res.name });
            }
                ...
                if (res.date) {
                    ...
                    _this.events[index].time = res.time;
                }
                else {
                    _this.events[index].location = res.location;
    ...
    EventsComponent.prototype.ngOnInit = function () {
        ...
        this.eventsService.getEvents().subscribe(function (events) {
            ...
            for (var i = 0; i < _this.events.length; i++) {
                ...
                _this.events[i].date = theDate;
                var time = new Date(_this.events[i].time);
                var hour = time.getHours();
                var minute = time.getMinutes();
                var theTime = {
                    hour: hour,
...
var SingleEventComponent = /** @class */ (function () {
    ...
    SingleEventComponent.prototype.convertAddress = function () {
        ...
        this.http.get('https://maps.googleapis.com/maps/api/geocode/json?address=' +
            ...
            .subscribe(function (res) {
            if (res.json().status == "ZERO_RESULTS") {
                _this.locationInfo = _this.event.location;
...
module.exports = "\r\n<div *ngIf=\"user\" class=\"body\">\r\n    <p-growl></p-growl>\r\n\r\n\r\n      <div (click)=\"fileInput.click()\" class=\"container profileP\">\r\n     <img class=\"profilePicture circle\" [src]=\"user.profilePic\" alt=\"\">\r\n     <div class=\"overlay circle\">\r\n        <p class=\"text circle\">Update profile picture</p>\r\n      </div>\r\n    </div>\r\n\r\n\r\n      <div class=\"welcome\">\r\n      <h3 >Welcome</h3>\r\n        <h3 class=\"username\">{{user.firstname}} {{user.lastname}}</h3>\r\n        \r\n          <div class=\"form-group\" enctype=\"multipart/form-data\">\r\n            <input  #fileInput style=\"display: none\" type=\"file\" (change)=\"onFileSelected($event)\">\r\n            <button *ngIf=\"saveChange\" mat-raised-button color=\"primary\" type=\"button\" (click)=\"uploadPhoto()\">save</button>\r\n            <button *ngIf=\"saveChange\" mat-raised-button color=\"accent\" type=\"button\" (click)=\"cancel()\">Cancel</button>\r\n          </div>\r\n        </div>\r\n          \r\n\r\n\r\n<button  mat-raised-button color=\"primary\" class=\"created-container\" (click)=\"showCreatedEvents()\">\r\n     {{user.events.length}} events  created\r\n</button>\r\n\r\n    <button mat-raised-button color=\"primary\" class=\"attending-container\" (click)=\"showAttendingEvents()\">\r\n       {{user.attending.length}} events attending\r\n  </button>\r\n<app-users-created-events class=\"created-events\" *ngIf=\"showMycreatedEvents\" (deletedEvents)=\"deleteEvent($event)\" (leaveEvents)=\"leaveEvent($event)\" (joinedEvents)=\"joinEvent($event)\"></app-users-created-events>\r\n<app-users-attending-events class=\"attending-events\" *ngIf=\"showMyattendingEvents\" (deletedEvents)=\"deleteEvent($event)\" (leaveEvents)=\"leaveEvent($event)\" (joinedEvents)=\"joinEvent($event)\"></app-users-attending-events>\r\n<button class=\"add-event\" mat-raised-button style=\"background-color:#39B7CD; color:white\" (click)=\"openCreateEventDialog()\"> Add Event</button>\r\n\r\n</div>\r\n\r\n\r\n\r\n\r\n\r\n\r\n    \r\n\r\n"
...
var ProfileComponent = /** @class */ (function () {
    // hosting:any
    // attending:any[]
    function ProfileComponent(authService, dialog, messageService) {
        this.authService = authService;
        this.dialog = dialog;
        this.messageService = messageService;
        this.host = JSON.parse(localStorage.getItem('user'));
    ...
    ProfileComponent.prototype.joinEvent = function (event) {
        console.log(event);
    ...
    ProfileComponent.prototype.leaveEvent = function (event) {
    ...
    ProfileComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"], _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatDialog"], primeng_components_common_messageservice__WEBPACK_IMPORTED_MODULE_4__["MessageService"]])
    ], ProfileComponent);
    ...
    UsersAttendingEventsComponent.prototype.openDialog = function (i) {
        ...
        dialog.afterClosed()
            ...
            if (!res) {
                ...
                _this.deletedEvents.emit({ i: i, _id: _this.events[i]._id, name: _this.events[i].name });
        ...
        dialog.afterClosed()
            ...
            if (!res) {
                ...
                if (_this.events[i]._id == res.eventId._id) {
                    ...
                    _this.leaveEvents.emit({ id: res.eventId, name: res.name });
                }
                ...
                _this.joinedEvents.emit({ id: res.eventId, name: res.name });
            }
            else if (res.name && !res.image) {
                console.log(res.name + " edit events");
                if (res.date) {
...
var SigninComponent = /** @class */ (function () {
    function SigninComponent(http, authService, router, messageService) {
        this.http = http;
        this.authService = authService;
        this.router = router;
        this.messageService = messageService;
    ...
    SigninComponent.prototype.onSignIn = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (res) {
            if (res.success) {
                ...
                _this.messageService.add({ severity: 'error', summary: 'Incorrect info', detail: 'The email or password you entered is invalid' });
            }
        });
    };
    __decorate([
...
var SignupComponent = /** @class */ (function () {
    function SignupComponent(http, authService, router, messageService) {
        this.http = http;
        this.authService = authService;
        this.router = router;
        this.messageService = messageService;
    ...
    SignupComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(this.user).subscribe(function (res) {
            ...
            if (res.success == "false") {
                _this.messageService.add({ severity: 'error', summary: 'Email active', detail: 'The email you are trying to sign up with is already being used' });
            }
            else {
